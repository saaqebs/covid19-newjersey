...
temp = 'https://www.nj.com/coronavirus/2020/{0}/where-is-the-coronavirus-in-nj-latest-map-update-on-town-by-town-cases-{1}.html'
...
def load_covid_data_into_dict(uncleaned_data, substring_errors, fullstring_errors):
    ...
    for row in uncleaned_data:
        ...
        num_infected = int(re.findall(r'^\d+', unclean_number)[0])
